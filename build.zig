...
pub fn build(b: *std.Build) void {
    ...
    const exe = b.addExecutable(.{
        ...
        .root_module = b.createModule(.{
            ...
            // root module.
            .imports = &.{
                // Here "shinydb_zig_client" is the name you will use in your source code to
                // import this module (e.g. `@import("shinydb_zig_client")`). The name is
    ...
    // Creates an executable for integration tests
